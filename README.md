...
Que tal fazer parte de um time com atitude? Participar de uma das maiores companias do Maranhão? Ter a oportunidade de trabalhar com tecnologias e conceitos inovadores, como:
...
* Flutter, NodeJs, React ou Angular 2+
* Flux (Redux, etc)
